        ...
        <div className="bg-white dark:bg-slate-800 rounded-lg shadow-lg p-8">
          ...
          <div className="prose dark:prose-invert max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                BillMeNow is a web-based invoicing and payment platform designed for freelancers 
                and small businesses. Our service includes:
              </p>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">
                6. Data Ownership and Backup
              </h2>
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                You retain ownership of all data you submit to our service. We provide:
              </p>
              <ul className="list-disc pl-6 text-gray-600 dark:text-gray-400 space-y-2">
                <li>Regular automated backups of your data</li>
                <li>Data export capabilities</li>
                <li>Secure data storage and transmission</li>
                <li>Data retention for a reasonable period after account closure</li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                To the maximum extent permitted by law, BillMeNow shall not be liable for any 
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 text-gray-600 dark:text-gray-400 space-y-2">
                <li>Email: legal@billmenow.com</li>
                <li>Address: BillMeNow Legal Team, [Your Business Address]</li>
              </ul>
            </section>
          </div>
        </div>
